...
- The server (the owner's other house, off the camera's LAN, P2P via Eufy's relay) got 1920×1080 from the same
...
1. **Aiming.** The presets survived the `goto` bug intact (§10.3); `reference.jpg` (2026-09-17 17:0x,
   ...
   Owner: eyeball it once for the sunrise framing (≈ 57°–123° true over the year at the shore),
